...
garden_harvest %>% 
  ...
  ggplot(aes(x = date, y = cum_wt_lbs, fill = fct_reorder(variety, cum_wt_lbs, .fun = max, .desc = FALSE))) +
  geom_area() +
...
![](mallorca_bike.gif)<!-- -->
  ...
  **I like the animation better because it feels more dynamic. It captures the audiences attention better and represnts the data better.**
...
**I always look at my home state of Maryland first and it looks like we are doing pretty good with covid, especially compared to some of the surrounding states. It is interesting how the midwest in general is the first to reach higher cases per 10,000, while the coasts remain lower for longer.**
...
Github Link: [here](https://github.com/tybenz12/Exercise-5)

.md Link: [here](https://github.com/tybenz12/Exercise-5/blob/main/05_exercises_new.md)
